...
def dashboard(request):
    # Filter tickets only for the logged-in user
    pending = Ticket.objects.filter(created_by=request.user, status='pending')
    solved = Ticket.objects.filter(created_by=request.user, status='solved')
